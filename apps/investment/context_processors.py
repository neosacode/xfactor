...
def accounts(request):
    ...
    checking_accounts = Accounts.objects.filter(user=request.user, currency__code='BTC', currency__type=Currencies.TYPES.checking)
    investment_accounts = Accounts.objects.filter(user=request.user, currency__code='BTC', currency__type=Currencies.TYPES.investment)
