...
from apps.investment.models import Investments, Incomes, Referrals, Comissions, Accounts, Graduations
        ...
        while True:
            ...
            for item in statement:
                ...
                with transaction.atomic():
                    ...
                    print('Paying {} comission to {} from {} advisor course'.format(comission_amount, advisor.username, user.username))